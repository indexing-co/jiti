const PARTIAL_VM_TO_NETWORK_MAP = {
  ...
  CARDANO: ['CARDANO'],
  FILECOIN: ['FILECOIN'],
  HEDERA: ['HEDERA_NATIVE'],
  HYPERCORE: ['HYPERCORE'],
  RIPPLE: ['RIPPLE'],
  STARKNET: ['STARKNET'],
  STELLAR: ['STELLAR'],
  SUBSTRATE: ['ASTAR', 'BITTENSOR', 'ENJIN', 'KUSAMA', 'MIDNIGHT', 'POLKADOT'],
  SUI: ['SUI'],
  SVM: ['ECLIPSE', 'FOGO', 'SOLANA', 'SOLANA_DEVNET'],
  TON: ['TON'],
  TRON: ['TRON'],
  UTXO: ['BITCOIN', 'BITCOIN_TESTNET', 'DOGECOIN', 'LITECOIN', 'ZCASH'],
};
